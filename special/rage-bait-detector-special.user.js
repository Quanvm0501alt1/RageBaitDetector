// ==UserScript==
// @name         @SamekoSaba Rage Bait Detector
// @namespace    http://tampermonkey.net/
// @version      0.8
// @description  Detects potential "rage bait" specifically for @SamekoSaba fans in posts on Facebook and X (Twitter), using GroqCloud and basic heuristics. This is a special version with enhanced keywords.
// @author       Your Name
...
(function() {
    ...
    if (currentUrl.includes("facebook.com")) {
        console.warn("Rage Bait Detector: Facebook functionality is currently limited. The script primarily works on X (Twitter). We are working on improving Facebook compatibility.");
    }
    ...
    function calculateHeuristicScore(text) {
        ...
        const keywords = [
            ...
            // Specific keywords for @SamekoSaba fans (added/expanded for this version)
            "saba is bad",
            "sameko is terrible",
            "overrated character",
            "worst design",
            ...
            "fandom is toxic",
            "sameko is cringe",
            "saba's voice is annoying",
            "sameko fans are annoying",
            "this character is pointless",
            "why do people like saba?",
            "saba is overrated",
            "sameko's design is lazy",
            "the story makes no sense with saba",
            "saba ruined the plot",
            "i can't stand sameko",
            "sameko is a Mary Sue",
            // Additional words for this special version
            "saba's annoying catchphrase",
            "sameko's plot armor",
            "this character is a joke",
            "sameko stans are delusional",
            "bring back the old saba",
            "saba needs to be nerfed",
            "sameko is just a filler character",
            "i skip all saba scenes",
            "saba is the worst part",
            "this show was better without sameko"
        ];
